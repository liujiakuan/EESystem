...
<head lang="en">
    ...
    <link rel="stylesheet" href="http://localhost:8080/EESystem/css/manager/indexId.css">
    ...
    <script type="text/javascript" src="http://localhost:8080/EESystem/js/manager/indexId.js"></script>
</head>
<body>
<div id="body">
