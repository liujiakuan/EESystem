...
<head lang="en">
    ...
    <link rel="stylesheet" href="http://localhost:8080/EESystem/css/error404.css">
    ...
    <script type="text/javascript" src="http://localhost:8080/EESystem/js/error404.js"></script>
</head>
<body>
<div id="body">
    <!-- 头部导航条 -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
                <p>
                    	404:您访问的页面信息不存在，对您造成的不便请原谅，我们将尽快处理。
                </p>
            </div>
            <div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
