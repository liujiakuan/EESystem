...
<head lang="en">
    ...
    <link rel="stylesheet" href="http://localhost:8080/EESystem/css/manager/epOrganize.css">
    ...
    <script type="text/javascript" src="http://localhost:8080/EESystem/js/manager/epOrganize.js"></script>
</head>
<body>
<div id="body">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="epOrganize col-xs-12 col-sm-12 col-md-10 col-lg-10">
                <!--中间个人信息展示部分-->
                <img src="http://localhost:8080/headImg/epOrganize/epOrganize.jpg" alt=epOrganize><hr>
            </div>
            <div class="changeImg col-md-4 col-lg-4 col-md-offset-5 col-lg-offset-5">
                <form action="/EESystem/uploadE.action" method="post" enctype="multipart/form-data">
                    <input name="epOrganizeImg" type="file" />
                    <input class="submit" type="submit" value="上传修改" />
                </form>
            </div>
        </div>
    </div>
