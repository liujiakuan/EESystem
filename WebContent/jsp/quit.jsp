...
<head lang="en">
    ...
    <link rel="stylesheet" href="http://localhost:8080/EESystem/css/quit.css">
    ...
    <script type="text/javascript" src="http://localhost:8080/EESystem/js/quit.js"></script>
</head>
<body>
<div id="body">
    <!-- 头部导航条 -->
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
            	<a href="http://localhost:8080/EESystem/jsp/employee/emp_login.jsp">员工登录</a>
            	<br>
            	<a href="http://localhost:8080/EESystem/jsp/login.jsp">点击返回首页管理员登录</a>
            </div>
        </div>
    </div>
</div>
