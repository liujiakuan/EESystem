...
public interface ManagerMapper {
	...
	//查询指定管理员，判断管理员登录的时候是否存在
	public ManagerPo checkManager(@Param("es_manager_login_count")String es_manager_login_count,@Param("es_manager_login_password")String es_manager_login_password)throws Exception;
	
	//管理员登录状态值，判断管理员登录状态,离线状态才能登录
	public int checkManagerState(@Param("es_manager_login_count")String es_manager_login_count,@Param("es_manager_login_password")String es_manager_login_password)throws Exception;
	...
	//返回指定区间的返回指定区间的员工
	public List<EmployeePo> admGetEmployeeList(@Param("pageNow")int pageNow,@Param("pageSize")int pageSize)throws Exception;

	//按照员工id查询得到指定员工
	public List<EmployeePo> admGetEmployeeById(@Param("es_employee_id")int es_employee_id,@Param("pageNow")int pageNow,@Param("pageSize")int pageSize)throws Exception;
	//得到数据表里面总的数据条数,通过id
	public int admGetEmployeeCountById(int es_employee_id)throws Exception;
	
	//按照员工名字模糊查询
	public List<EmployeePo> admGetEmployeeByName(@Param("es_employee_name")String es_employee_name,@Param("pageNow")int pageNow,@Param("pageSize")int pageSize)throws Exception;
	//得到数据表里面总的数据条数，通过name
	public int admGetEmployeeCountByName(String es_employee_name)throws Exception;
	
	//按照员工部门查询得到指定员工
	public List<EmployeePo> admGetEmployeeByDepartment(@Param("es_employee_department")String es_employee_department,@Param("pageNow")int pageNow,@Param("pageSize")int pageSize)throws Exception;
