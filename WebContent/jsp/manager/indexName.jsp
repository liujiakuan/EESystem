...
<head lang="en">
    ...
    <link rel="stylesheet" href="http://localhost:8080/EESystem/css/manager/indexName.css">
    ...
    <script type="text/javascript" src="http://localhost:8080/EESystem/js/manager/indexName.js"></script>
</head>
<body>
<div id="body">
            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-9">
                ...
                <div class="row">
                    <div class="changePage col-xs-12 col-sm-4 col-md-6 col-lg-4 col-md-offset-1 col-lg-offset-1">
                        ...
                        <a href="/EESystem/admEmployeeListSearchPageName.action?page=upOne&&pagenow=${pageNow}&&es_employee_name=${es_employee_name}">上一页</a>
                        <a href="/EESystem/admEmployeeListSearchPageName.action?page=nextOne&&pagenow=${pageNow}&&es_employee_name=${es_employee_name}">下一页</a>
                        <a href="/EESystem/admEmployeeListSearchPageName.action?page=firstPage&&pagenow=${pageNow}&&es_employee_name=${es_employee_name}">首页</a>
                        <a href="/EESystem/admEmployeeListSearchPageName.action?page=endPage&&pagenow=${pageNow}&&es_employee_name=${es_employee_name}">尾页</a>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-6 col-lg-4">
                        <form action="/EESystem/admEmployeeListSearchPageNameE.action" method="get">
                        	<input type="hidden" name="pagenow" value="${pageNow}">
                        	<input type="hidden" name="es_employee_name" value="${es_employee_name}">
