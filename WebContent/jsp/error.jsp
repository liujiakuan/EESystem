...
<head lang="en">
    ...
    <link rel="stylesheet" href="http://localhost:8080/EESystem/css/error.css">
    ...
    <script type="text/javascript" src="http://localhost:8080/EESystem/js/error.js"></script>
</head>
<body>
<div id="body">
    <!-- 头部导航条 -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
                <p>
                    	Error:系统信息错误，对您造成的不便请原谅，我们将尽快处理。
                </p>
            </div>
            <div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
