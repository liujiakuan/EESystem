...
<head lang="en">
    ...
    <link rel="stylesheet" href="http://localhost:8080/EESystem/css/manager/employee.css">
    ...
    <script type="text/javascript" src="http://localhost:8080/EESystem/js/manager/employee.js"></script>
</head>
<body>
<div id="body">
                    ...
                    <table id="table" class="table table-bordered">
                        ...
                        <tr>
                            <td class="imgHeaderAppear" colspan="2" rowspan="4">
                                <img class="headAppear" src="${employeePo.es_employee_img}" alt="HeadAppear">
                            </td>
                            <td colspan="1" class="keyId">ID:</td>
                            <td colspan="1" class="valueId">${employeePo.es_employee_id}</td>
                            <td colspan="1" class="keyId">姓名:</td>
                            <td colspan="1" class="valueId">${employeePo.es_employee_name}</td>
                            <td colspan="1" class="keyId">年龄:</td>
                            <td colspan="2" class="valueId">${employeePo.es_employee_age}</td>
                        </tr>
                        <tr>
                            <td colspan="1" class="keyId">性别:</td>
                            <td colspan="1" class="valueId">${employeePo.es_employee_sex}</td>
                            <td colspan="1" class="keyId">婚否:</td>
                            <td colspan="1" class="valueId">${employeePo.es_employee_marriage}</td>
                            <td colspan="1" class="keyId">身份证:</td>
                            <td colspan="2" class="valueId">${employeePo.es_employee_idcard}</td>
                        </tr>
                        <tr>
                            <td colspan="1" class="keyId">学历:</td>
                            <td colspan="1" class="valueId">${employeePo.es_employee_qualification}</td>
                            <td colspan="1" class="keyId">专业:</td>
                            <td colspan="1" class="valueId">${employeePo.es_employee_major}</td>
                            <td colspan="1" class="keyId">毕业院校:</td>
                            <td colspan="2" class="valueId">${employeePo.es_employee_school}</td>
                        </tr>
                        <tr>
                            <td colspan="1" class="keyId">部门:</td>
                            <td colspan="1" colspan="2" class="valueId">${employeePo.es_employee_department}</td>
                            <td colspan="1" class="keyId">职位:</td>
                            <td colspan="1" class="valueId">${employeePo.es_employee_post}</td>
                            <td class="keyId" colspan="1">入职日期:</td>
                            <td class="valueId" colspan="2">
                            <time><fmt:formatDate value="${employeePo.es_employee_entry}" pattern="yyyy-MM-dd "/></time>
                            </td>
                        </tr>
                        <tr>
                            <td class="keyId" colspan="1">联系方式:</td>
                            <td class="valueId" colspan="3">${employeePo.es_employee_call}</td>
                            <td class="keyId" colspan="1">邮箱:</td>
                            <td class="valueId" colspan="4">${employeePo.es_employee_mail}</td>
                        </tr>
                        <tr>
                            <td class="keyId" colspan="1">qq:</td>
                            <td class="valueId" colspan="3">${employeePo.es_employee_qq}</td>
                            <td class="keyId" colspan="1">微信:</td>
                            <td class="valueId" colspan="4">${employeePo.es_employee_wechat}</td>
                        </tr>
                        <tr>
                            <td class="keyId" colspan="1">工资卡号:</td>
                            <td class="valueId" colspan="2">${employeePo.es_employee_bankcard}</td>
                            <td class="keyId" colspan="1">劳动保障证号:</td>
                            <td class="valueId" colspan="2">${employeePo.es_employee_labourcard}</td>
                            <td class="keyId" colspan="1">公积金账号:</td>
                            <td class="valueId" colspan="2">${employeePo.es_employee_pafcard}</td>
                        </tr>
                        <tr>
                            <td class="keyId" colspan="1" rowspan="2">紧急联系人:</td>
                            <td class="keyId" colspan="1">关系:</td>
                            <td class="valueId" colspan="1">${employeePo.contactsPoList.get(0).es_employee_contacts_relation}</td>
                            <td class="keyId" colspan="1">姓名:</td>
                            <td class="valueId" colspan="1">${employeePo.contactsPoList.get(0).es_employee_contacts_name}</td>
                            <td class="keyId" colspan="1">联系方式:</td>
                            <td class="valueId" colspan="3">${employeePo.contactsPoList.get(0).es_employee_contacts_call}</td>
                        </tr>
                        <tr>
                            <td class="keyId" colspan="1">关系:</td>
                            <td class="valueId" colspan="1">${employeePo.contactsPoList.get(1).es_employee_contacts_relation}</td>
                            <td class="keyId" colspan="1">姓名:</td>
                            <td class="valueId" colspan="1">${employeePo.contactsPoList.get(1).es_employee_contacts_name}</td>
                            <td class="keyId" colspan="1">联系方式:</td>
                            <td class="valueId" colspan="3">${employeePo.contactsPoList.get(1).es_employee_contacts_call}</td>
                        </tr>
                        <tr>
                            <td class="keyId" colspan="1">户籍地:</td>
                            <td class="valueId" colspan="3">${employeePo.es_employee_pod}</td>
                            <td class="keyId" colspan="1">现居住地:</td>
                            <td class="valueId" colspan="4">${employeePo.es_employee_domicile}</td>
                        </tr>
                        <tr>
                            <td class="keyId" colspan="1">座右铭:</td>
                            <td class="valueId" colspan="8">${employeePo.es_employee_motto}
                            </td>
                        </tr>
                        <tr>
                            <td class="keyId" colspan="1">目标:</td>
                            <td class="valueId" colspan="8">${employeePo.es_employee_aim}</td>
                        </tr>
                        <tr>
                            <td class="keyId" colspan="1">爱好:</td>
                            <td class="valueId" colspan="8">${employeePo.es_employee_hobby}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
