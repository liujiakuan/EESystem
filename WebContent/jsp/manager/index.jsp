...
<head lang="en">
    ...
    <link rel="stylesheet" href="http://localhost:8080/EESystem/css/manager/index.css">
    ...
    <script type="text/javascript" src="http://localhost:8080/EESystem/js/manager/index.js"></script>
</head>
<body>
<div id="body">
            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-9">
                ...
                <div class="row">
                    <div class="changePage col-xs-12 col-sm-4 col-md-6 col-lg-4 col-md-offset-1 col-lg-offset-1">
                        ...
                        <a href="/EESystem/admEmployeeListSearchPage.action?page=upOne&&pagenow=${pageNow}">上一页</a>
                        <a href="/EESystem/admEmployeeListSearchPage.action?page=nextOne&&pagenow=${pageNow}">下一页</a>
                        <a href="/EESystem/admEmployeeListSearchPage.action?page=firstPage&&pagenow=${pageNow}">首页</a>
                        <a href="/EESystem/admEmployeeListSearchPage.action?page=endPage&&pagenow=${pageNow}">尾页</a>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-6 col-lg-4">
                        <form action="/EESystem/admEmployeeListSearchPageF.action" method="get">
